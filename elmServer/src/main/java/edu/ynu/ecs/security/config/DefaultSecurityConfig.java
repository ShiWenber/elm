...
import edu.ynu.ecs.security.JWT.JwtAuthenticationFilter;
import edu.ynu.ecs.security.JWT.JwtUtils;
import edu.ynu.ecs.security.JWT.hanlder.AuthenticationFailureHandlerImpl;
import edu.ynu.ecs.security.JWT.hanlder.AuthenticationSuccessHandlerImpl;
...
public class DefaultSecurityConfig implements InitializingBean {
    ...
    public SecurityFilterChain sysSecurityFilterChain(HttpSecurity http,
        ...
        var getIgnoreToken = new String[]{"/order/**", "/doc.html", "/pub/**", "/swagger-ui/**", "/webjars/**", "/v3/**", "/druid/**"};
